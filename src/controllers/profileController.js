...
const getDegrees = async (req, res) => {
    try {
        ...
        //JOIN to securely get degrees of the user
...
const updateDegree = async (req, res) => {
    try {
        ...
        //Update only if the degree belongs to the profile
        const [result] = await pool.query(
...
const deleteDegree = async (req, res) => {
    try {
        ...
        //Delete only if it belongs to the profile
        const [result] = await pool.query(
